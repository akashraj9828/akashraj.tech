...
const Header = ({ theme, themeConfig, dispatch }) => {
	const [menuOpen, setMenuOpen] = useState(false);
	const [themeLabOpen, setThemeLabOpen] = useState(false);
	const menuButton = useRef(null);
	const themeLabButton = useRef(null);
			...
			<header className='site-header'>
				<nav className='navbar' aria-label='Primary navigation'>
					...
					<div className='header-actions'>
						...
						<button ref={themeLabButton} className='theme-lab-trigger' type='button' onClick={() => setThemeLabOpen(true)} aria-label='Open theme experiments' aria-haspopup='dialog' aria-expanded={themeLabOpen}>
				...
				<ThemeLab open={themeLabOpen} theme={themeConfig} dispatch={dispatch} onClose={() => setThemeLabOpen(false)} triggerRef={themeLabButton} />
			</header>
		</>
	);
};

const mapStateToProps = (state) => ({ theme: state.app.theme, themeConfig: state.app.themeConfig });
